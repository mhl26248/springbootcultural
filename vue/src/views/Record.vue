...
<!--    </div>-->
    ...
    <!--    搜索区域-->
    <div style="margin: 10px 0">
      <el-input v-model="search" placeholder="请输入申请号" style="width: 20%" clearable></el-input>
      <el-button type="primary" style="margin-left: 5px" @click="load">查询</el-button>
      <el-button  @click="add">创建申请</el-button>
    </div>
    <el-table
        v-loading="loading"
        :data="tableData"
...
<!--      </el-table-column>-->
      ...
      <el-table-column
          prop="inDate"  min-width="120"
          label="预约日期">
      </el-table-column>
      <el-table-column min-width="150"
          label="状态">
        <template #default="scope">
          <el-tag v-if="scope.row.status == 0">创建</el-tag>
          <el-tag type="danger" v-if="scope.row.status == 1">已登记</el-tag>
          <el-tag type="danger" v-if="scope.row.status == 2">已签署</el-tag>
          <el-tag type="danger" v-if="scope.row.status == 3">已预约</el-tag>
          <el-tag type="danger" v-if="scope.row.status == 4">到达现场</el-tag>
          <el-tag type="success" v-if="scope.row.status == 5">已完成</el-tag>
          <el-tag type="info" v-if="scope.row.status == 6">已取消</el-tag>
          <el-tag type="info" v-if="scope.row.status == 7">已确认待签署</el-tag>
        </template>
      </el-table-column>
...
<!--          </el-popconfirm>-->
    ...
    <el-dialog title="提示—需要先选择预约日期 才能选择医生" v-model="dialogVisible" width="70%">
      ...
      <el-form ref="form"   :model="form" label-width="80px">
        ...
        <el-form-item label="选择医生">
          <el-select v-model="form.doctorId" @click="loadDoctors">
            <el-option
        ...
        <el-form-item label="身份证">
          <el-input v-model="form.idNo" style="width: 30%"></el-input>
        </el-form-item>
        <el-form-item label="手机">
          <el-input v-model="form.mobile" style="width: 30%"></el-input>
        </el-form-item>
<!--        <el-form-item label="申请编号">-->
<!--          <el-input v-model="form.recordNo"  style="width: 30%"></el-input>-->
<!--&lt;!&ndash;          <el-button  type="primary">扫描</el-button>&ndash;&gt;-->
<!--        </el-form-item>-->
...
<!--&lt;!&ndash;          <el-input v-model="form.outDate" style="width: 40%"></el-input>&ndash;&gt;-->
<!--          <el-date-picker-->
...
<!--        </el-form-item>-->
        <el-form-item label="申请说明">
          <el-input v-model="form.inRemark" style="width: 80%"></el-input>
        </el-form-item>
