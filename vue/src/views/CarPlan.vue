<template>
  <div style="padding: 10px">
    ...
    <el-table
      ...
      <el-table-column label="操作" width="400">
        <template #default="scope">
          ...
          <el-button size="mini" @click="handleEdit2(scope.row)">编辑2</el-button>
    ...
    <el-dialog title="查看线路" v-model="dialogVisible" width="70%">
      <iframe
    ...
    <el-dialog title="查看线路" v-model="dialogVisible2" width="70%">
      <iframe
          id="iframeMapViewComponent2"
          ref="iframeDom"
          name="iframeMap"
          :src="getUrl2"
          width="95%"
