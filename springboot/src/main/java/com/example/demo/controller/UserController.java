...
//        如果不包含，则返回false，不需要重新登录。
    ...
    @GetMapping("/getPlaceIdByDriverId")
    public Result<?> getPlaceIdByDriverId(int driverId) {
        return Result.success(userMapper.getPlaceIdByDriverId(driverId));
    }
    ...
    @GetMapping("/getAllPlaceManager")
    public Result<?> getAllPlaceManager() {
        return Result.success(userMapper.getPlaceManager());
    }
